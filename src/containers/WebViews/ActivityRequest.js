...
class ActivityRequest extends Component {
    state = {
        loading: true
    }
    static contextType = NetworkContext;
    static navigationOptions = ({ navigation }) => (navigationOption(navigation, 'Activity Request'))
...
export default connect(mapStateToProps, mapDispatchToProps)(ActivityRequest)