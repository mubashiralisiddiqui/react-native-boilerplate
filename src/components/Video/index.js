...
import React, {
  ...
  import Video from 'react-native-video';
import { mediaStoragePath, brandColors } from '../../constants';
    ...
    render() {
      ...
      return (
        <View style={styles.container}>
            <View style={{position: 'absolute', zIndex: 10000, top: 10, right: 10, }}>
                <Button
                    type="clear"
                    title={'close'}
                    titleStyle={{ color: brandColors.lightGreen , fontFamily: 'Lato-SemiboldItalic' }}
                    onPress={() => this.props.onClose(this.state.seconds)}
                    icon={<FontAwesomeIcon size={30} name="window-close" color={brandColors.lightGreen} />}
                />
            </View>
          <TouchableOpacity
          ...
          >
            <Video
              ...
              /* For ExoPlayer */
              source={{ uri: `/${mediaStoragePath}/${this.props.file.FileName}`, type: 'mp4' }}
