...
import { CallReason, ReportingEmployeeField, SearchDoctor } from '..'
...
const KeyCallInfoUnplanned = (props) => {
    ...
    return (
        <View style={inlineStyles.cardcontainer}>
            ...
            <View style={{width: width < height ? parseInt(width / 1.2) : parseInt(width / 1.2), ...inlineStyles.formContainer}}>
                ...
                {
                    isUserRSM && <ReportingEmployeeField name={info.SelectedEmployeeName} setMio={props.setMio} />
                }
...
export default KeyCallInfoUnplanned;
